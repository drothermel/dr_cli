...
from dr_cli.typecheck.models import MessageLevel
...
class TestParserMethods:
    ...
    def test_diagnostic_parsing_creates_error_model(
    ...
    def test_diagnostic_parsing_creates_warning_model(
        self, parser: MypyOutputParser
    ) -> None:
    ...
    def test_note_association_without_diagnostic(
        self, parser: MypyOutputParser
    ) -> None:
